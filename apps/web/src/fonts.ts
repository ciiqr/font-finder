...
const bigShouldersStencilDisplay = Big_Shoulders_Stencil_Display({
    subsets: ["latin-ext"],
});
...
const notoSansAdlamUnjoined = Noto_Sans_Adlam_Unjoined({
    subsets: ["latin-ext"],
});
...
const notoSansHanifiRohingya = Noto_Sans_Hanifi_Rohingya({
    subsets: ["latin-ext"],
});
...
export const fonts: Font[] = [
    ...
    { name: "Alegreya", css: alegreya },
    { name: "Alexandria", css: alexandria },
    { name: "Alkatra", css: alkatra },
    { name: "Alumni Sans", css: alumniSans },
    { name: "Andada Pro", css: andadaPro },
    { name: "Anek Bangla", css: anekBangla },
    { name: "Anek Devanagari", css: anekDevanagari },
    { name: "Anek Gujarati", css: anekGujarati },
    { name: "Anek Gurmukhi", css: anekGurmukhi },
    { name: "Anek Kannada", css: anekKannada },
    { name: "Anek Latin", css: anekLatin },
    { name: "Anek Malayalam", css: anekMalayalam },
    { name: "Anek Odia", css: anekOdia },
    { name: "Anek Tamil", css: anekTamil },
    { name: "Anek Telugu", css: anekTelugu },
    { name: "Antonio", css: antonio },
    { name: "Anuphan", css: anuphan },
    { name: "Anybody", css: anybody },
    { name: "Archivo Narrow", css: archivoNarrow },
    { name: "Archivo", css: archivo },
    { name: "Arima", css: arima },
    { name: "Arimo", css: arimo },
    { name: "Asap", css: asap },
    { name: "Assistant", css: assistant },
    { name: "Azeret Mono", css: azeretMono },
    { name: "Ballet", css: ballet },
    { name: "Baloo 2", css: baloo2 },
    { name: "Baloo Bhai 2", css: balooBhai2 },
    { name: "Baloo Bhaijaan 2", css: balooBhaijaan2 },
    { name: "Baloo Bhaina 2", css: balooBhaina2 },
    { name: "Baloo Chettan 2", css: balooChettan2 },
    { name: "Baloo Da 2", css: balooDa2 },
    { name: "Baloo Paaji 2", css: balooPaaji2 },
    { name: "Baloo Tamma 2", css: balooTamma2 },
    { name: "Baloo Tammudu 2", css: balooTammudu2 },
    { name: "Baloo Thambi 2", css: balooThambi2 },
    { name: "Besley", css: besley },
    { name: "Big Shoulders Display", css: bigShouldersDisplay },
    { name: "Big Shoulders Inline Display", css: bigShouldersInlineDisplay },
    { name: "Big Shoulders Inline Text", css: bigShouldersInlineText },
    { name: "Big Shoulders Stencil Display", css: bigShouldersStencilDisplay },
    { name: "Big Shoulders Stencil Text", css: bigShouldersStencilText },
    { name: "Big Shoulders Text", css: bigShouldersText },
    { name: "Bitter", css: bitter },
    { name: "Bodoni Moda", css: bodoniModa },
    { name: "Brygada 1918", css: brygada1918 },
    { name: "Cabin", css: cabin },
    { name: "Cairo Play", css: cairoPlay },
    { name: "Cairo", css: cairo },
    { name: "Catamaran", css: catamaran },
    { name: "Caveat", css: caveat },
    { name: "Changa", css: changa },
    { name: "Chivo Mono", css: chivoMono },
    { name: "Chivo", css: chivo },
    { name: "Cinzel", css: cinzel },
    { name: "Climate Crisis", css: climateCrisis },
    { name: "Comfortaa", css: comfortaa },
    { name: "Comme", css: comme },
    { name: "Commissioner", css: commissioner },
    { name: "Cormorant", css: cormorant },
    { name: "Crimson Pro", css: crimsonPro },
    { name: "Cuprum", css: cuprum },
    { name: "Dancing Script", css: dancingScript },
    { name: "Domine", css: domine },
    { name: "Dosis", css: dosis },
    { name: "DynaPuff", css: dynaPuff },
    { name: "EB Garamond", css: ebGaramond },
    { name: "Eczar", css: eczar },
    { name: "El Messiri", css: elMessiri },
    { name: "Encode Sans SC", css: encodeSansSc },
    { name: "Encode Sans", css: encodeSans },
    { name: "Epilogue", css: epilogue },
    { name: "Exo 2", css: exo2 },
    { name: "Exo", css: exo },
    { name: "Expletus Sans", css: expletusSans },
    { name: "Familjen Grotesk", css: familjenGrotesk },
    { name: "Faustina", css: faustina },
    { name: "Figtree", css: figtree },
    { name: "Finlandica", css: finlandica },
    { name: "Fira Code", css: firaCode },
    { name: "Foldit", css: foldit },
    { name: "Frank Ruhl Libre", css: frankRuhlLibre },
    { name: "Fraunces", css: fraunces },
    { name: "Fredoka", css: fredoka },
    { name: "Gantari", css: gantari },
    { name: "Gemunu Libre", css: gemunuLibre },
    { name: "Genos", css: genos },
    { name: "Georama", css: georama },
    { name: "Glory", css: glory },
    { name: "Gluten", css: gluten },
    { name: "Golos Text", css: golosText },
    { name: "Grandstander", css: grandstander },
    { name: "Grenze Gotisch", css: grenzeGotisch },
    { name: "Hahmlet", css: hahmlet },
    { name: "Hanken Grotesk", css: hankenGrotesk },
    { name: "Hepta Slab", css: heptaSlab },
    { name: "Ibarra Real Nova", css: ibarraRealNova },
    { name: "Imbue", css: imbue },
    { name: "Inconsolata", css: inconsolata },
    { name: "Inter Tight", css: interTight },
    { name: "Inter", css: inter },
    { name: "JetBrains Mono", css: jetBrainsMono },
    { name: "Josefin Sans", css: josefinSans },
    { name: "Jost", css: jost },
    { name: "Jura", css: jura },
    { name: "Kantumruy Pro", css: kantumruyPro },
    { name: "Karla", css: karla },
    { name: "Kreon", css: kreon },
    { name: "Kufam", css: kufam },
    { name: "Kumbh Sans", css: kumbhSans },
    { name: "Labrada", css: labrada },
    { name: "League Gothic", css: leagueGothic },
    { name: "League Spartan", css: leagueSpartan },
    { name: "Lemonada", css: lemonada },
    { name: "Lexend Deca", css: lexendDeca },
    { name: "Lexend Exa", css: lexendExa },
    { name: "Lexend Giga", css: lexendGiga },
    { name: "Lexend Mega", css: lexendMega },
    { name: "Lexend Peta", css: lexendPeta },
    { name: "Lexend Tera", css: lexendTera },
    { name: "Lexend Zetta", css: lexendZetta },
    { name: "Lexend", css: lexend },
    { name: "Libre Bodoni", css: libreBodoni },
    { name: "Libre Franklin", css: libreFranklin },
    { name: "Literata", css: literata },
    { name: "Lora", css: lora },
    { name: "M PLUS 1 Code", css: mplus1Code },
    { name: "M PLUS 1", css: mplus1 },
    { name: "M PLUS 2", css: mplus2 },
    { name: "M PLUS Code Latin", css: mplusCodeLatin },
    { name: "Manrope", css: manrope },
    { name: "Manuale", css: manuale },
    { name: "Marhey", css: marhey },
    { name: "Markazi Text", css: markaziText },
    { name: "Martian Mono", css: martianMono },
    { name: "Maven Pro", css: mavenPro },
    { name: "Merienda", css: merienda },
    { name: "Merriweather Sans", css: merriweatherSans },
    { name: "Mohave", css: mohave },
    { name: "Montagu Slab", css: montaguSlab },
    { name: "Montserrat", css: montserrat },
    { name: "Mulish", css: mulish },
    { name: "Murecho", css: murecho },
    { name: "MuseoModerno", css: museoModerno },
    { name: "Nabla", css: nabla },
    { name: "Newsreader", css: newsreader },
    { name: "Noto Naskh Arabic", css: notoNaskhArabic },
    { name: "Noto Nastaliq Urdu", css: notoNastaliqUrdu },
    { name: "Noto Rashi Hebrew", css: notoRashiHebrew },
    { name: "Noto Sans Adlam Unjoined", css: notoSansAdlamUnjoined },
    { name: "Noto Sans Adlam", css: notoSansAdlam },
    { name: "Noto Sans Armenian", css: notoSansArmenian },
    { name: "Noto Sans Balinese", css: notoSansBalinese },
    { name: "Noto Sans Bamum", css: notoSansBamum },
    { name: "Noto Sans Bassa Vah", css: notoSansBassaVah },
    { name: "Noto Sans Bengali", css: notoSansBengali },
    { name: "Noto Sans Canadian Aboriginal", css: notoSansCanadianAboriginal },
    { name: "Noto Sans Cham", css: notoSansCham },
    { name: "Noto Sans Cherokee", css: notoSansCherokee },
    { name: "Noto Sans Devanagari", css: notoSansDevanagari },
    { name: "Noto Sans Display", css: notoSansDisplay },
    { name: "Noto Sans Ethiopic", css: notoSansEthiopic },
    { name: "Noto Sans Georgian", css: notoSansGeorgian },
    { name: "Noto Sans Gujarati", css: notoSansGujarati },
    { name: "Noto Sans Gurmukhi", css: notoSansGurmukhi },
    { name: "Noto Sans Hanifi Rohingya", css: notoSansHanifiRohingya },
    { name: "Noto Sans Hebrew", css: notoSansHebrew },
    { name: "Noto Sans Javanese", css: notoSansJavanese },
    { name: "Noto Sans JP", css: notoSansJp },
    { name: "Noto Sans Kannada", css: notoSansKannada },
    { name: "Noto Sans Kayah Li", css: notoSansKayahLi },
    { name: "Noto Sans Khmer", css: notoSansKhmer },
    { name: "Noto Sans Lao Looped", css: notoSansLaoLooped },
    { name: "Noto Sans Lao", css: notoSansLao },
    { name: "Noto Sans Lisu", css: notoSansLisu },
    { name: "Noto Sans Malayalam", css: notoSansMalayalam },
    { name: "Noto Sans Medefaidrin", css: notoSansMedefaidrin },
    { name: "Noto Sans Meetei Mayek", css: notoSansMeeteiMayek },
    { name: "Noto Sans Mono", css: notoSansMono },
    { name: "Noto Sans New Tai Lue", css: notoSansNewTaiLue },
    { name: "Noto Sans Ol Chiki", css: notoSansOlChiki },
    { name: "Noto Sans Oriya", css: notoSansOriya },
    { name: "Noto Sans Sinhala", css: notoSansSinhala },
    { name: "Noto Sans Sora Sompeng", css: notoSansSoraSompeng },
    { name: "Noto Sans Sundanese", css: notoSansSundanese },
    { name: "Noto Sans Symbols", css: notoSansSymbols },
    { name: "Noto Sans Syriac", css: notoSansSyriac },
    { name: "Noto Sans Tai Tham", css: notoSansTaiTham },
    { name: "Noto Sans Tamil", css: notoSansTamil },
    { name: "Noto Sans Tangsa", css: notoSansTangsa },
    { name: "Noto Sans Telugu", css: notoSansTelugu },
    { name: "Noto Sans Thaana", css: notoSansThaana },
    { name: "Noto Sans Thai", css: notoSansThai },
    { name: "Noto Serif Armenian", css: notoSerifArmenian },
    { name: "Noto Serif Bengali", css: notoSerifBengali },
    { name: "Noto Serif Devanagari", css: notoSerifDevanagari },
    { name: "Noto Serif Display", css: notoSerifDisplay },
    { name: "Noto Serif Ethiopic", css: notoSerifEthiopic },
    { name: "Noto Serif Georgian", css: notoSerifGeorgian },
    { name: "Noto Serif Gujarati", css: notoSerifGujarati },
    { name: "Noto Serif Gurmukhi", css: notoSerifGurmukhi },
    { name: "Noto Serif Hebrew", css: notoSerifHebrew },
    { name: "Noto Serif HK", css: notoSerifHk },
    { name: "Noto Serif Kannada", css: notoSerifKannada },
    { name: "Noto Serif Khmer", css: notoSerifKhmer },
    { name: "Noto Serif Khojki", css: notoSerifKhojki },
    { name: "Noto Serif Lao", css: notoSerifLao },
    { name: "Noto Serif Malayalam", css: notoSerifMalayalam },
    { name: "Noto Serif Oriya", css: notoSerifOriya },
    { name: "Noto Serif Sinhala", css: notoSerifSinhala },
    { name: "Noto Serif Tamil", css: notoSerifTamil },
    { name: "Noto Serif Telugu", css: notoSerifTelugu },
    { name: "Noto Serif Thai", css: notoSerifThai },
    { name: "Noto Serif Tibetan", css: notoSerifTibetan },
    { name: "Noto Serif Toto", css: notoSerifToto },
    { name: "Nunito Sans", css: nunitoSans },
    { name: "Nunito", css: nunito },
    { name: "Open Sans", css: openSans },
    { name: "Oswald", css: oswald },
    { name: "Outfit", css: outfit },
    { name: "Overpass Mono", css: overpassMono },
    { name: "Overpass", css: overpass },
    { name: "Oxanium", css: oxanium },
    { name: "Pathway Extreme", css: pathwayExtreme },
    { name: "Petrona", css: petrona },
    { name: "Phudu", css: phudu },
    { name: "Piazzolla", css: piazzolla },
    { name: "Playfair Display", css: playfairDisplay },
    { name: "Plus Jakarta Sans", css: plusJakartaSans },
    { name: "Podkova", css: podkova },
    { name: "Poltawski Nowy", css: poltawskiNowy },
    { name: "Pontano Sans", css: pontanoSans },
    { name: "Public Sans", css: publicSans },
    { name: "Quicksand", css: quicksand },
    { name: "Radio Canada", css: radioCanada },
    { name: "Raleway", css: raleway },
    { name: "Rasa", css: rasa },
    { name: "Readex Pro", css: readexPro },
    { name: "Recursive", css: recursive },
    { name: "Red Hat Display", css: redHatDisplay },
    { name: "Red Hat Mono", css: redHatMono },
    { name: "Red Hat Text", css: redHatText },
    { name: "Red Rose", css: redRose },
    { name: "Reem Kufi Fun", css: reemKufiFun },
    { name: "Reem Kufi", css: reemKufi },
    { name: "Roboto Flex", css: robotoFlex },
    { name: "Roboto Mono", css: robotoMono },
    { name: "Roboto Serif", css: robotoSerif },
    { name: "Roboto Slab", css: robotoSlab },
    { name: "Rokkitt", css: rokkitt },
    { name: "Rosario", css: rosario },
    { name: "Rubik", css: rubik },
    { name: "Ruda", css: ruda },
    { name: "Saira", css: saira },
    { name: "Sansita Swashed", css: sansitaSwashed },
    { name: "Schibsted Grotesk", css: schibstedGrotesk },
    { name: "Shantell Sans", css: shantellSans },
    { name: "Signika Negative", css: signikaNegative },
    { name: "Signika", css: signika },
    { name: "Smooch Sans", css: smoochSans },
    { name: "Sofia Sans Condensed", css: sofiaSansCondensed },
    { name: "Sofia Sans Extra Condensed", css: sofiaSansExtraCondensed },
    { name: "Sofia Sans Semi Condensed", css: sofiaSansSemiCondensed },
    { name: "Sofia Sans", css: sofiaSans },
    { name: "Sono", css: sono },
    { name: "Sora", css: sora },
    { name: "Source Code Pro", css: sourceCodePro },
    { name: "Source Sans 3", css: sourceSans3 },
    { name: "Source Serif 4", css: sourceSerif4 },
    { name: "Space Grotesk", css: spaceGrotesk },
    { name: "Spline Sans Mono", css: splineSansMono },
    { name: "Spline Sans", css: splineSans },
    { name: "Stick No Bills", css: stickNoBills },
    { name: "STIX Two Text", css: stixTwoText },
    { name: "Syne", css: syne },
    { name: "Texturina", css: texturina },
    { name: "Tourney", css: tourney },
    { name: "Trispace", css: trispace },
    { name: "Truculenta", css: truculenta },
    { name: "Unbounded", css: unbounded },
    { name: "Urbanist", css: urbanist },
    { name: "Varta", css: varta },
    { name: "Vazirmatn", css: vazirmatn },
    { name: "Vollkorn", css: vollkorn },
    { name: "Work Sans", css: workSans },
    { name: "Yaldevi", css: yaldevi },
    { name: "Yanone Kaffeesatz", css: yanoneKaffeesatz },
    { name: "Yrsa", css: yrsa },
    { name: "Ysabeau", css: ysabeau },
];
